...
public class JpThongTin extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Cà phê là một loại thức uống được ủ từ hạt cà phê rang, lấy từ quả của cây cà phê Các giống cây cà phê ");

        jLabel6.setText("được bắt nguồn từ vùng nhiệt đới châu Phi và các vùng Madagascar, Comoros, Mauritius và Réunion trên Ấn Độ Dương");
